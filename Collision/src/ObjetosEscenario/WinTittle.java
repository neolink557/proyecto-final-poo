...
public class WinTittle implements CharacterColisionable, CharacterDibujable {

    private Image imagen = new ImageIcon(getClass().getResource("../resources/escenario/fon5.png")).getImage();
    private int x = 0;
    private int y = 0;
